        ...
        <div class="d-flex">
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" data-bs-toggle="dropdown"
                    ...
                    <img id="header-lang-img" src="<?=Yii::getAlias('@web')?>/themes/backend/admin-assets/images/uk.png" alt="Header Language"
                        height="16">
                </button>
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="en">
                        <img src="<?=Yii::getAlias('@web')?>/themes/backend/admin-assets/images/uk.png" alt="user-image" class="me-1" height="12">
                        <span class="align-middle">English</span>
                    </a>
                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="gr">
                        <img src="<?=Yii::getAlias('@web')?>/themes/backend/admin-assets/images/india.png" alt="user-image" class="me-1" height="12">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                    ...
                    <div data-simplebar style="max-height: 230px;">
                        ...
                        <a href="javascript:void(0);" class="text-reset notification-item">
                            <div class="media">
                                <img src="<?=Yii::getAlias('@web')?>/themes/backend/admin-assets/images/avatar-3.jpg" class="me-3 rounded-circle avatar-xs"
                                    alt="user-pic">
                                <div class="media-body">
                        ...
                        <a href="javascript:void(0);" class="text-reset notification-item">
                            <div class="media">
                                <img src="<?=Yii::getAlias('@web')?>/themes/backend/admin-assets/images/avatar-4.jpg" class="me-3 rounded-circle avatar-xs"
                                    alt="user-pic">
                                <div class="media-body">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    ...
                    <img class="rounded-circle header-profile-user" src="<?=Yii::getAlias('@web')?>/themes/backend/admin-assets/images/avatar-1.jpg"
                        alt="Header Avatar">
