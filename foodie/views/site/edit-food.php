...
$this->title = 'Foodieits- Edit Food';
?>
...
<section class="breadcrumb-section light-bg">
    <div class="container">
        <div class="breadcrumb-text">
            ...
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?= Url::to(['site/order']) ?>">Order List</a></li>
    ...
    <div class="container">
        <form>
            ...
            <div class="text-right">
                <a href="<?= Url::to(['site/order']) ?>" class="btn btn-primary">Update</a>
            </div>
        </form>
    </div>
</section>