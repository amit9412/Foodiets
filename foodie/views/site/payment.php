            ...
            <div class="col-lg-9 col-md-8">
                <div class="user-tabs">
                    <ul class="nav nav-pills" id="pills-tab">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="all-payment-tab" data-toggle="pill" href="#all-payment">Complete
                                Payment</a>
                        </li>
                    </ul>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Full</td>
                                            <td>1</td>
                                            <td><span class="badge badge-pill badge-success">Delivered</span>
                                            </td>
                                            <td>Cash</td>
                                            <td>
                                                <button type="button" class="btn btn-secondary btn-sm"><i
