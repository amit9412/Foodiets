            ...
            <div class="col-lg-9 col-md-8">
                <div class="user-tabs">
                    <ul class="nav nav-pills" id="pills-tab">
                        <li class="nav-item">
                            <a class="nav-link active" id="today-order-tab" data-toggle="pill" href="#today-order">Today
                                Order</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="all-order-tab" data-toggle="pill" href="#all-order">Completed
                                Orders</a>
                        </li>
                    </ul>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>1</td>
                                            <td>
                                                <button type="button" data-toggle="modal" data-target="#orderCancel"
                                                    class="btn btn-danger btn-sm"> Cancel</button>
                                            </td>
                                            <td>
                                                <a href="<?= Url::to(['site/edit-food']) ?>" class="btn btn-primary btn-sm"><i
                                                        class="fa fa-edit"></i></a>
                                                <button type="button" data-toggle="modal" data-target="#viewInfo"
