                ...
                <form class="form-horizontal" action="dashboards.php">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group auth-pass-inputgroup">
                            ...
                            <button class="btn btn-light" type="button" id="confirm-password"><i
                                    class="mdi mdi-eye-outline"></i></button>
                        </div>
                    </div>
                    <div class="mb-3">
                        <div class="form-check form-check-success">
                            ...
                            <label class="form-check-label text-muted" for="remember-check">
                                Accept all <a href="javascript:void(0);" class="fw-medium text-dark">Terms &
                                    Conditions</a> or <a href="javascript:void(0);" class="fw-medium text-dark">Privacy
                                    Policy</a>
                            </label>
                        </div>
                    </div>
                    <div class="mt-3 d-grid">
                        <a href="<?php echo BASE_URL ?>/vendor-panel/verification-otp.php"
                            class="btn btn-success waves-effect waves-light"> Continue</a>
                    </div>
                    <div class="mt-4 text-center">
                        <span class="text-muted">
                            Already have an account? <a href="<?php echo BASE_URL ?>/vendor-panel/index.php"
                                class="fw-medium text-dark"> Login</a>
                        </span>
                    </div>
                </form>
            </div>
