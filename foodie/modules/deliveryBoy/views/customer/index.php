        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="<?= Url::to(['/deliveryBoy/dashboard']) ?>">Dashboards</a></li>
                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= Url::to(['/deliveryBoy/customer/view', 'id' => $singleValue->id]) ?>" class=" btn p-0 avatar-xs btn-primary waves-effect waves-light">
