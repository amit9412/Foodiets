...
$this->title = Yii::t("app", "Today Order");
?>
            ...
            <div class="tab-pane active" id="morning-order" role="tabpanel">
                <div class="d-flex flex-wrap justify-content-between">
                    ...
                    <div class="button-items text-end mb-0">
                        <button type="button" class="btn btn-primary btn-sm w-xs waves-effect waves-light">Order
                            Delivered</button>
                    </div>
                </div>
                    ...
                    <table class="table align-middle table-nowrap mb-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>A Group</td>
                                <td>
                                    <a href="<?= Url::to(['deliveryboy-profile/customer/customer-details']) ?>"
