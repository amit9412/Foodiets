...
<div class="card">
    <div class="card-body">
        <div class="d-flex flex-wrap justify-content-between mb-2">
            ...
            <div class="">
                <a href="<?= Url::to(['/vendor-panel/product/add-product']) ?>"
        ...
        <div class="table-responsive">
            <table class="table align-middle table-nowrap mb-0">
                ...
                <tbody>
                    <tr>
                        <td>#1</td>
                        <td><img src="<?= Yii::getAlias('@web') ?>/themes/backend/admin-assets/images/avatar-2.jpg"
                        ...
                        <td>
                            ...
                            <a href="javascript:void(0);" class="btn p-0 avatar-xs btn-danger waves-effect waves-light">
