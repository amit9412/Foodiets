...
$this->title = Yii::t("app", "Vendor | Pending Invoice");
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Pending Invoice</h4>
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="<?= Url::to(['/vendor-panel/dashboard']) ?>">Dashboards</a>
                    </li>
            ...
            <div class="tab-pane active" id="admin-invoice" role="tabpanel">
                <div class="d-flex flex-wrap align-items-center justify-content-between mb-3">
                    ...
                    <div class="button-items text-end">
                        ...
                        <button type="button" class="btn btn-success w-xs btn-sm waves-effect waves-light">Send
                            Invoice</button>
                    </div>
                </div>
                    ...
                    <table class="table align-middle table-nowrap mb-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>05/08/2021</td>
                                <td>
                                    <a href="<?= Url::to(['/vendor-panel/invoice/invoice-details']) ?>"
