            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item"><a
                            href="<?= Url::to(['/vendor-panel/invoice/pending-invoice']) ?>">Pending Invoice</a></li>
...
<div class="card">
    <div class="card-body">
        <div class="invoice-title">
            ...
            <div class="mb-3">
                <img src="<?= Yii::getAlias('@web') ?>/themes/backend/admin-assets/images/logo-light.svg" alt="logo"
                    height="50" />
            </div>
        </div>
        <hr>
