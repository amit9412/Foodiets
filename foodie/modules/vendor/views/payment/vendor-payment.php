...
$this->title = Yii::t("app", "Vendor | Payment");
...
<div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18">Vendor Payment</h4>
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a
                                                href="<?= Url::to(['/vendor-panel/dashboard']) ?>">Dashboards</a></li>
                                        ...
                                        <table class="table align-middle table-nowrap mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>05/08/2021</td>
                                                    <td>You</td>
                                                    <td><button type="button" class="btn btn-success w-xs btn-sm waves-effect waves-light">Pay</button></td>
                                                    <td>
                                                        <a href="javascript:void(0);" class="btn p-0 avatar-xs btn-primary waves-effect waves-light">
