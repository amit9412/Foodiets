                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item"><a
                                                href="<?php echo BASE_URL?>/super-admin/customers.php">Customer List</a></li>
                        ...
                        <div class="col-lg-5">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div>
                                        <dl class="row mb-0">
                                            <dt class="col-sm-6 mb-sm-2 mb-1">Vendor Name</dt>
                                            <dd class="col-sm-6 mb-sm-2 mb-3">John</dd>
                                            <dt class="col-sm-6 mb-sm-2 mb-1">Customer Id</dt>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <ul class="nav nav-tabs nav-tabs-custom mb-3" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" data-bs-toggle="tab" href="#latest-order"
                                                role="tab">
                                                Latest Order
                                            </a>
                                        </li>
                                                ...
                                                <table class="table align-middle table-nowrap mb-0">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <span
                                                                    class="badge bg-success font-size-11">Delivered</span>
                                                            </td>
                                                            <td>
