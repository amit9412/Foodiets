                    ...
                    <div class="card overflow-hidden">
                        <div class="card-body"> 
                            ...
                            <form class="form-horizontal" action="">        
                                ...
                                <div class="text-end">
                                    <a href="<?php echo BASE_URL ?>/super-admin/dashboard.php" class="btn btn-primary w-md waves-effect waves-light"> Change</a>
                                </div>
                                <div class="mt-4 text-center">
                                    <span class="text-muted">
                                        Back <a href="<?php echo BASE_URL ?>/super-admin/index.php" class="fw-medium text-primary"> Click here</a>
                                    </span>                                    
                                </div>
                            </form>       
                        </div>
