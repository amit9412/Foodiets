                    ...
                    <div class="card overflow-hidden">
                        <div class="card-body"> 
                            ...
                            <form class="form-horizontal" action="">        
                                ...
                                <div class="text-end">
                                    <a href="<?php echo BASE_URL ?>/delivery-boy/dashboard.php" class="btn btn-success w-md waves-effect waves-light"> Reset</a>
                                </div>
                                <div class="mt-4 text-center">
                                    <span class="text-muted">
                                        Remember It ? <a href="<?php echo BASE_URL ?>/delivery-boy/index.php" class="fw-medium text-dark"> Login Here</a>
                                    </span>                                    
                                </div>
                            </form>       
                        </div>
