                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            ...
                            <form class="form-horizontal" action="orders.php">
                                <div class="mb-3">
                                ...
                                <div class="text-end">
                                    <a href="<?php echo BASE_URL ?>/delivery-boy/forgot-password.php" class="text-muted"><i
                                            class="mdi mdi-lock me-1"></i> Forgot your password?</a>
                                </div>
                                <div class="mt-3 d-grid">
                                    <a href="<?php echo BASE_URL ?>/delivery-boy/orders.php"
