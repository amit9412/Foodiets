                            ...
                            <div class="accordion" id="accordionExample">
                                <div class="faq-card">
                                    <div class="faq-header" id="headingOne">
                                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true"
                                                aria-controls="collapseOne"  ><span>Q.1</span> How do I become an author?</a>
                                    </div>
                                ...
                                <div class="faq-card">
                                    <div class="faq-header" id="headingTwo">
                                        <a href="javascript:void(0);" class="collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false"
                                                aria-controls="collapseTwo"><span>Q.2</span> Tips for Increasing Your Referral Income?</a>
                                    </div>
                                ...
                                <div class="faq-card">
                                    ...
                                    <a href="javascript:void(0);" data-toggle="collapse" data-target="#collapseThree"
                                                aria-expanded="false" aria-controls="collapseThree"><span>Q.3</span> Tips for Increasing Your Referral Income?</a>
                                    </div>
