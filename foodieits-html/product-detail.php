...
<html lang="en">
  <head>
    ...
    <title>Foodieits- Product Detail</title>
  </head>
  <body>
    <main>
                                ...
                                <div class="product-box mb-0">
                                    ...
                                    <div class="product-box-txt">                            
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mt-2 mb-2">
                                            ...
                                            <ul class="social">
                                                <li>
                                                    <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="" data-original-title="Share to Facebook">
                                                        <em class="fa fa-facebook-f"></em>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="" data-original-title="Share to Instagram">
                                                        <em class="fa fa-instagram"></em>
                                                    </a>                                           
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="" data-original-title="Share to Linkedin">
                                                        <em class="fa fa-linkedin"></em>
                                                    </a>
                                                    
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="" data-original-title="Share to Whatsapp">
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                  <tr>
                                                    ...
                                                    <td>
                                                        <div class="break-txt">
                                                            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Error sed consectetur rem voluptatibus id tempore tenetur molestias asperiores autem vitae perspiciatis quisquam est nemo vel fugiat reprehenderit odit, in doloremque.
                                                        </div>
                                                    </td>
                                                  </tr>
                                                  <tr>
                                        ...
                                        <div class="owl-carousel mb-3 gallery-owl owl-theme">
                                            <div class="item">
                                                <div class="gallery-box">
                                                    <img src="<?php echo IMAGES_URL?>/gallery-1.jpg" alt="">
                                                </div>
                                            </div>
                                            <div class="item">
                                                <div class="gallery-box">
                                                    <img src="<?php echo IMAGES_URL?>/gallery-2.jpg" alt="">
                                                </div>
                                            </div>
                                            <div class="item">
                                                <div class="gallery-box">
                                                    <img src="<?php echo IMAGES_URL?>/gallery-3.jpg" alt="">
                                                </div>
                                            </div>
                                            <div class="item">
                                                <div class="gallery-box">
                                                    <img src="<?php echo IMAGES_URL?>/gallery-4.jpg" alt="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center justify-content-between mb-3">
                                            <h2 class="mb-0">Tour Reviews</h2>
                                            <a href="javascript:void(0);" class="btn btn-primary" data-toggle="modal" data-target="#addReviews">Add Reviews</a>
                                        </div>                                        
                                        <div class="reviews-media">
                                            <div class="media">
                                                <div class="reviews-img">
                                                    <img src="<?php echo IMAGES_URL?>/reviews-1.png" alt="">
                                                </div>                                                
                                                <div class="media-body">
                                                  ...
                                                  <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Reiciendis qui soluta dolorem facere veritatis esse explicabo nostrum quas perferendis cumque repellat, debitis, rerum provident nulla corrupti mollitia inventore labore sint.</p>
                                                </div>
                                            </div>
                                            <div class="media">
                                                <div class="reviews-img">
                                                    <img src="<?php echo IMAGES_URL?>/reviews-2.png" alt="">
                                                </div>                                                
                                                <div class="media-body">
                                                  <h6>Luaka Smith</h6>
                                                  <div class="d-flex align-items-center justify-content-between">
